<form action="" method="post">
    ...
    <section class="teacher-dialogue">
        ...
        <div class="ex-quest">
            <div>
                <span>2.</span>
                <div><img src="../images/gifCircOR.gif" alt="quest1"></div>
            </div>
        </div>
    </section>
    ...
    <section class="container-alternative">
        ...
        <div class="content">
            ...
            <div class="alternative"><input type="radio" value="r" name="al1"><span>Função <u>OU</u></span></div>
        </div>
    </section>
...
<section class="next-ex">
    <div class="game-button">
            <a href="<?php nextExCalc("has_completed_lvl1exe2",1,$db,$_SESSION) ?>" class="botton-line-important">Vamos para a próxima fase!</a>
        </form>
    </div>
</section>