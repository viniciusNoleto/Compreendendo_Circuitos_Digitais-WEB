<form action="" method="post">
    ...
    <section class="container-alternative-drag">
        <div class="drop-target"><span>1</span><div id="w" draggable="true"><img src="../images/functionForExNAND.png" alt=""></div></div>
        <div class="drop-target"><span>2</span><div id="w" draggable="true"><img src="../images/functionForExOR.png" alt=""></div></div>
        <div class="drop-target"><span>3</span><div id="r" draggable="true"><img src="../images/functionForExAND.png" alt=""></div></div>
...
<section class="next-ex">
    <div class="game-button">
        <a class="botton-line-important" href="<?php nextExCalc("has_completed_lvl2exe2",2,$db,$_SESSION) ?>">Vamos para a próxima fase!</a>
    </div>
</section>