<form action="" method="post">
    ...
    <section class="container-alternative-drag">
        ...
        <div class="drop-target"><div id="r" class="2" draggable="true"><img src="../images/functionForExNOR.png" alt=""></div></div>
...
<section class="next-ex">
    <div class="game-button">
        <a class="botton-line-important" href="<?php nextExCalc("has_completed_lvl2exe7",2,$db,$_SESSION) ?>">Vamos para a próxima fase!</a>
    </div>
</section>