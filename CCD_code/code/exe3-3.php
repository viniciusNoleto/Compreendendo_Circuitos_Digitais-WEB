...
<form action="" method="post">
    ...
    <section class="teacher-dialogue">
        ...
        <div class="ex-quest">
            <div>
                <span>3.</span>
                <div><img src="../images/tabelaVerXNOR.png" alt="quest3"></div>
    ...
    <section class="container-alternative-drag">
        ...
        <div class="drop-target"><div id="r" draggable="true"><img src="../images/functionForExXNOR.png" alt=""></div></div>
...
<section class="next-ex">
    <div class="game-button">
        <a class="botton-line-important" href="<?php nextExCalc("has_completed_lvl3exe3",3,$db,$_SESSION) ?>">Vamos para a próxima fase!</a>
    </div>
</section>
