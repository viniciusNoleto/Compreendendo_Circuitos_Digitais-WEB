...
<form action="" method="post">
    ...
    <section class="teacher-dialogue">
        ...
        <div class="ex-quest">
            <div>
                <span>7.</span>
                <div><img src="../images/ex2-tabelaVer-img (2).png" alt="quest1"></div>
...
<section class="next-ex">
    <div class="game-button">
        <a class="botton-line-important" href="<?php nextExCalc("has_completed_lvl3exe7",3,$db,$_SESSION) ?>">Vamos para a próxima fase!</a>
    </div>
</section>
