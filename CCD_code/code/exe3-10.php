...
<form action="" method="post">
    ...
    <section class="teacher-dialogue">
        ...
        <div class="ex-quest">
            <div>
                <span>10.</span>
                <div><img src="../images/ex2-tabelaVer-img (5).png" alt="quest1"></div>
    ...
    <section class="container-alternative-drag">
        <b>1</b>
        <div class="drop-target"><div id="r" class="1" draggable="true"><img src="../images/functionForExNAND.png" alt=""></div></div>
        <div class="drop-target"><div id="w" class="1" draggable="true"><img src="../images/functionForExNOR.png" alt=""></div></div>
        <div class="drop-target"><div id="w" class="1" draggable="true"><img src="../images/functionForExXNOR.png" alt=""></div></div>
        <div class="drop-target"><div id="w" class="1" draggable="true"><img src="../images/functionForExNOT.png" alt=""></div></div>
        <b>2</b>
...
<section class="next-ex">
    <div class="game-button">
        <a class="botton-line-important" href="<?php nextExCalc("has_completed_lvl3exe10",3,$db,$_SESSION) ?>">Vamos para a próxima fase!</a>
    </div>
</section>
