...
<form action="" method="post">
    <section class="teacher-dialogue">
        ...
        <div class="ex-quest">
            <div>
                <span>6.</span>
                <div><img src="../images/ex2-tabelaVer-img (1).png" alt="quest6"></div>
    ...
    <section class="container-alternative-drag">
        ...
        <div class="drop-target"><div id="w" class="2" draggable="true"><img src="../images/functionForExAND.png" alt=""></div></div>
        <div class="drop-target"><div id="w" class="2" draggable="true"><img src="../images/functionForExXOR.png" alt=""></div></div>
        <div class="drop-target"><div id="r" class="2" draggable="true"><img src="../images/functionForExOR.png" alt=""></div></div>
    </section>
...
<section class="next-ex">
    <div class="game-button">
        <a class="botton-line-important" href="<?php nextExCalc("has_completed_lvl3exe6",3,$db,$_SESSION) ?>">Vamos para a próxima fase!</a>
    </div>
</section>
